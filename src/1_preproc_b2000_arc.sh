...
mrdegibbs $mrtrix_out/${1}/${2}/preproc/dwi_b2000.mif $mrtrix_out/${1}/${2}/preproc/dwi_b2000_degibbs.mif -info
...
dwifslpreproc $mrtrix_out/${1}/${2}/preproc/dwi_b2000_degibbs.mif $mrtrix_out/${1}/${2}/preproc/${1}_${2}_dwi_b2000_preprocessed.mif \
...
dwi2mask $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_preprocessed.mif $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_mask.mif 

#Convert preprocessed output and mask to .nii for QC via eddy_quad
mrconvert $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_preprocessed.mif $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_preprocessed.nii.gz -export_grad_fsl $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_preprocessed.bvec $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_preprocessed.bval -json_export $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_preprocessed.json 
mrconvert $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_mask.mif $mrtrix_out/${1}/${2}/${1}_${2}_dwi_b2000_mask.nii.gz 
